...
class DoctorsForCancerViewController: UIViewController,ChartViewDelegate {
    ...
    private func bubbleChartViewSetup() {
        ...
        let chartYAxis:ChartYAxis = bubbleChartView.leftAxis
        chartYAxis.labelFont = UIFont(name: "HelveticaNeue-Light", size: 10.0)!
        chartYAxis.spaceTop = 0.3
        chartYAxis.spaceBottom = 0.3
        chartYAxis.axisMinValue = 0.0
        
        bubbleChartView.rightAxis.enabled = false
        
        let chartXAXis:ChartXAxis = bubbleChartView.xAxis
        chartXAXis.labelFont = UIFont(name: "HelveticaNeue-Light", size: 10.0)!
        chartXAXis.labelPosition = ChartXAxis.LabelPosition.Bottom
    }
    ...
    private func bubbleChartData() {
        ...
        dataSet4.drawValuesEnabled = true
        ...
        dataSet5.drawValuesEnabled = true
